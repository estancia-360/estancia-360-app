...
@Module({
    ...
    providers: [RegisterMovementUseCase, ConfirmMovementAnimalUseCase, CancelMovementUseCase, RegisterAnimalExitUseCase, UpdateAnimalExitUseCase],
    exports: [RegisterMovementUseCase, ConfirmMovementAnimalUseCase, CancelMovementUseCase, RegisterAnimalExitUseCase, UpdateAnimalExitUseCase],
})
