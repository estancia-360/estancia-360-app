...
@Module({
    imports: [RanchSubscriptionsModule, SubscriptionPaymentsModule, RanchUsersModule],
    controllers: [SubscriptionsController],
    providers: [SubscriptionsService, ActivatePlanUseCase, RegisterSubscriptionPaymentUseCase, CancelSubscriptionUseCase],
})
